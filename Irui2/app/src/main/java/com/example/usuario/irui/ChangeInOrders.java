...
/**
 * Helper class for showing and canceling change in orders
 * notifications.
 * <p/>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class ChangeInOrders {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "ChangeInOrders";
     ...
     * presentation of change in orders notifications. Make
     * sure to follow the
